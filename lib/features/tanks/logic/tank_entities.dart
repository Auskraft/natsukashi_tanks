...
class Tank {
  ...
  /// Реально упёрся в этом кадре (попытка шага не удалась) — для обхода у AI.
  /// Важно: не путать с «не сдвинулся за кадр» (при высокой герцовке танк за
  /// кадр копит меньше суб-клетки и просто ещё не шагнул — это НЕ упор).
  bool blocked = false;
